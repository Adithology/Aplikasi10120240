...
//        });
        instagram.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                gotoUrl("https://instagram.com/apphhrroditt?igshid=MzNlNGNkZWQ4Mg==");
            }
        });
    ...
    public void ClickGallery(View view) {
        //redirect to gallery
        HomeActivity.redirectActivity(this, com.example.aplikasi10120240.Gallery.class);
    }

    public void ClickDaily(View view) {
        //redirect to gallery
        HomeActivity.redirectActivity(this, com.example.aplikasi10120240.Daily.class);
    }
    ...
    public static void About(final Activity activity) {
        ...
        //set message
        builder.setMessage("BDR v1.0 This App Contains Personal Data About Aditya Sukmadinata");
    ...
    public void onButtonTap(View v) {
        ...
        intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"https://instagram.com/apphhrroditt?igshid=MzNlNGNkZWQ4Mg=="});
    ...
    public void callClick(View view) {
        ...
        intentCall.setData(Uri.parse("tel:08158054430"));
