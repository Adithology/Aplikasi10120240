...
public class WalkThrough1 extends AppCompatActivity {
    ...
    private com.example.aplikasi10120240.OnBoardingAdapter onBoardingAdapter;
        ...
        OnBoardingAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(onBoardingViewPager.getCurrentItem() + 1 < onBoardingAdapter.getItemCount()){
                    ...
                    startActivity(new Intent(getApplicationContext(), com.example.aplikasi10120240.HomeActivity.class));
                    finish();
                }
            }
        });
    ...
    private void setupOnBoardingItems(){
        List<com.example.aplikasi10120240.OnBoardingItem> onBoardingItems = new ArrayList<>();
        com.example.aplikasi10120240.OnBoardingItem item1 = new com.example.aplikasi10120240.OnBoardingItem();
        item1.setTittle("Hi, there!");
        item1.setDescription("Welcome to My Self Apps");
        item1.setImage(R.drawable.ic_welcome);

        com.example.aplikasi10120240.OnBoardingItem item2 = new com.example.aplikasi10120240.OnBoardingItem();
        ...
        com.example.aplikasi10120240.OnBoardingItem item3 = new com.example.aplikasi10120240.OnBoardingItem();
        ...
        onBoardingAdapter = new com.example.aplikasi10120240.OnBoardingAdapter(onBoardingItems);
    }
